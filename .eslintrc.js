...
module.exports = {
    ...
    globals : {
        ...
        // This is a hack to get around mixed CJS & ESM code in this codebase :-\
        "module": true,

        // Build-time flags that can be used in conditionals for code-stripping
        "ISBROWSER" : true,
        "ISGAME"    : true
    },
    ...
    rules : {
        ...
        "new-cap"                  : [ "error", {
            capIsNewExceptionPattern : "^engine\."
        }],
        ...
        // TODO: this will become an error soon
        ...
        "no-new-symbol"          : "error",
        // Ban specific modules from being imported
        ...
        // Disallow generated functions that do not have yield
        "require-yield"          : "error",
